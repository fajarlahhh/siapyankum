    ...
    <div class="col-12">
      <div class="widget-list widget-list-rounded m-b-30" data-id="widget">
        @foreach ($data as $index => $row)
          <a href="/frontend/pendapatsaran/{{ $row->pendapat_saran_id }}" class="widget-list-item"
            style="background: #8af5ff; border-color: #8af5ff; ">
            <div class="widget-list-content">
              <h4 class="widget-list-title"><b>{{ $row->pendapat_saran_laporan_nomor }}</b> <br>
                {{ $row->pendapat_saran_judul }}</h4>
            </div>
