    ...
    <div class="col-12">
      <div class="widget-list widget-list-rounded m-b-30" data-id="widget">
        @foreach ($data as $index => $row)
          <a href="/frontend/bantuanhukum/{{ $jenis }}/{{ $row->bantuan_hukum_id }}"
            class="widget-list-item bg-yellow">
            <div class="widget-list-content">
              <h4 class="widget-list-title"><b>{{ $row->bantuan_hukum_laporan_nomor }}</b> <br>
                {{ $row->bantuan_hukum_judul }}</h4>
            </div>
