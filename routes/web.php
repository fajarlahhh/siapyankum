...
Route::group(['middleware' => ['auth']], function () {
  ...
  Route::group(['middleware' => ['role_or_permission:administrator|penelitiancatatanhukum']], function () {
    Route::get('/penelitiancatatanhukum', 'LitcatkumController@index')->name('penelitiancatatanhukum');
    Route::get('/penelitiancatatanhukum/edit/{id}', 'LitcatkumController@edit')->middleware(['role:administrator|user']);
    Route::put('/penelitiancatatanhukum/edit', 'LitcatkumController@do_edit')->middleware(['role:administrator|user'])->name('penelitiancatatanhukum.edit');
    Route::get('/penelitiancatatanhukum/tambah', 'LitcatkumController@tambah')->middleware(['role:administrator|user'])->name('penelitiancatatanhukum.tambah');
    Route::post('/penelitiancatatanhukum/tambah', 'LitcatkumController@do_tambah')->middleware(['role:administrator|user']);
    Route::delete('/penelitiancatatanhukum/hapus/{id}', 'LitcatkumController@hapus')->middleware(['role:administrator|user']);
  });
