  ...
  public function do_tambah(Request $req)
  {
    $req->validate(
      [
        ...
        'peraturan_tanggal.required' => 'Tanggal tidak boleh kosong',
      ]
    );
    try
    {
      ...
      $peraturan->peraturan_tanggal = $req->get('peraturan_tanggal');
      $peraturan->peraturan_file = 'public/upload/peraturan/' . $nama_file;
